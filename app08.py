...
if len(text_input) >= 1:
    if text_input == 'tech2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 08 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"Merry Christmas! Wishing you all the happiness your holiday can hold!"')
        st.image("santa.gif")
    if text_input != 'tech2023':
        st.markdown(
