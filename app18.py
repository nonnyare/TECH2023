...
if len(text_input) >= 1:
    if text_input == '2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 18 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"Wishing you safe travels and that you become closer to all those that you treasure in your heart this Christmas season."')
        st.image("santa.gif")
    if text_input != '2023':
        st.markdown(
