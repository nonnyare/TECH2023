...
if len(text_input) >= 1:
    if text_input == '49tech2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 16 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"Peace, good will, and happiness for you this Christmas and every other!"')
        st.image("santa.gif")
    if text_input != '49tech2023':
        st.markdown(
