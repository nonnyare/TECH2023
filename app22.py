...
if len(text_input) >= 1:
    if text_input == '49tech2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 22 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"Have a great Christmas and a wonderful New Year."')
        st.image("santa.gif")
    if text_input != '49tech2023':
        st.markdown(
