...
if len(text_input) >= 1:
    if text_input == 'tech2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 15 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"Merry Christmas! May your happiness be large and your bills be small."')
        st.image("santa.gif")
    if text_input != 'tech2023':
        st.markdown(
