...
if len(text_input) >= 1:
    if text_input == 'tech2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 13 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"May the Christmas Season bring only happiness and joy to you and your family."')
        st.image("santa.gif")
    if text_input != 'tech2023':
        st.markdown(
