...
if len(text_input) >= 1:
    if text_input == '2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 07 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"May your holidays sparkle with joy and laughter."')
        st.image("santa.gif")
    if text_input != '2023':
        st.markdown(
