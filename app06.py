...
if len(text_input) >= 1:
    if text_input == '49tech2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 06 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"Wishing you a season full of light and laughter for you and your family."')
        st.image("santa.gif")
    if text_input != '49tech2023':
        st.markdown(
