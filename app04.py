...
if len(text_input) >= 1:
    if text_input == '49tech2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 04 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"Merry Christmas! Wishing you all the best this holiday season!"')
        st.image("santa.gif")
    if text_input != '49tech2023':
        st.markdown(
