...
if len(text_input) >= 1:
    if text_input == 'tech2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 19 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"Sending you love, strength and unwavering support this holiday season."')
        st.image("santa.gif")
    if text_input != 'tech2023':
        st.markdown(
