...
if len(text_input) >= 1:
    if text_input == '2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 12 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"Wishing you love, joy and peace … today, tomorrow and always."')
        st.image("santa.gif")
    if text_input != '2023':
        st.markdown(
