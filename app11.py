...
if len(text_input) >= 1:
    if text_input == '49tech2023':
        ...
        st.markdown(
            '<p class="medium-font-font">You got a gift <strong style="color:red"> -> No. 11 <- </strong> from lovely Santa...</p>'
            , unsafe_allow_html=True)
        st.write('"May your family have a holiday season that is full of wonderful surprises, treats and nonstop laughter."')
        st.image("santa.gif")
    if text_input != '49tech2023':
        st.markdown(
